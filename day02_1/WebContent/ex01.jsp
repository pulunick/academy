...
<table>
	...
	<tr>
		...
		<td>사용자가 전달한 모든 파라미터를 map형태로 가져온다</td>
	...
	<tr>
		...
		<td>요청받은 쿼리스트링을 문자열로 반환한다. 다듬으면 파라미터가 된다
			<a href="ex01.jsp?name=Messi%age=35"><button>예시</button></a>
		</td>
		<td><%=request.getQueryString() %></td>
	</tr>
	<tr>
		<td>getHedar(String headerName)</td>
		<td>요청 헤더에서 담긴 특정 요소를 문자열 형태로 반환한다(referer는 참조자, 어디에서 왔는가)</td>
