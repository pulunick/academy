...
<ul>
	...
	<li><a href="${cpath }/ex02">ex02 - 인증번호 보내기</a></li>
	<li><a href="${cpath }/ex03">ex03 - javascript for문의 of와 in</a></li>
</ul>
		...
		<ol>
			...
			<li>
				...
				<p>
					...
					DELETE : 서버의 특정 데이터를 삭제하는 것이 목적이다. body를 가지지 않는다(queryString)<br>
				</p>
			</li>
		</ol>
	</fieldset>
